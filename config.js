...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Nimesha;Skl11;0;https://chat.whatsapp.com/IF6KENyxjwyAvBHmJ0zqup',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Nimesha",
    BOT_NAME: process.env.BOT_NAME || 'Nimesha',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;NINESHA WHATSAPP BOT;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "94786286300",
